...
public interface SysUserMapper extends BaseMapper<SysUser> {
    ...
    @Insert("insert into sys_user (username,realname,password,dept_id,job_id,phone,email,avatar,lock_flag) values (#{username},#{realname},#{password},#{deptId},#{jobId},#{phone},#{email},#{avatar},#{lockFlag})")
